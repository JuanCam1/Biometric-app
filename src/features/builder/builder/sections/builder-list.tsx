...
const BuilderList = () => {
  return (
    <div className="gap-4 grid md:grid-cols-2 lg:grid-cols-4">
      {torres.map((torre) => (
        <Card key={torre.id} className="dark:bg-zinc-900 dark:border-zinc-600 overflow-hidden">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="top-0 right-0 absolute">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="center" className="dark:bg-zinc-800">
