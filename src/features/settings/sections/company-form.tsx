...
const CompanyForm = () => {
  const [logo, setLogo] = useState<string | null>("/placeholder.svg?height=100&width=100")
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="flex gap-2">
              ...
              {logo && logo !== "/placeholder.svg?height=100&width=100" && (
                <Button type="button" variant="outline" size="sm" className="mt-2" onClick={handleRemoveLogo}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Breve descripción de la empresa" className="resize-none" {...field} />
                  </FormControl>
