...
INSERT INTO "new_Visit" ("administrationAreaId", "apartmentId", "authorizerId", "dateEntry", "dateExit", "id", "observation", "stateId", "timeEntry", "timeExit", "visitantId") SELECT "administrationAreaId", "apartmentId", "authorizerId", "dateEntry", "dateExit", "id", "observation", "stateId", "timeEntry", "timeExit", "visitantId" FROM "Visit";
DROP TABLE "Visit";
